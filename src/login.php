...
if (!empty($_POST['emaill']) && !empty($_POST['passwordd'])) {
    ...
    $users = $req->fetchAll();
    if (count($users) > 0) {
        foreach ($users as $user ) {//$req->fetch()
            if ($password == $user['password']) {
                $_SESSION['connect'] = 1;
                $_SESSION['email']   = $user['email'];
                $_SESSION['role']   = 'Client';
                $_SESSION['profil']   = $user['profilImage'];
                ...
                <div class="row my-5">
                    ...
                    <div class="col border pe-5">
                        ...
                        <form method="POST" action="inscription.php">
                            ...
                            <div class="input-group m-3">
                                <span class="input-group-text">Votre email</span>
                                <input type="email" name="preEmail" id="preEmail" class="form-control" placeholder="exemple@google.fr">
                            </div>
                            <div class="col-12 d-md-flex justify-content-md-end ">
