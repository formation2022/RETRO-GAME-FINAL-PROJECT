...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="people-circle1" viewBox="0 0 16 16">
        ...
        <div class="px-3 py-2 text-bg-dark">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="/src/admin/admin-login.php" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                    ...
                    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                        ...
                        if (isset($_SESSION['connect']) && $_SESSION['connect'] == 1 && $_SESSION['role'] == 'Admin') { ?>
                            <li>
                                <a href="../admin/admin-ventes.php" class="nav-link text-white">
                                    <svg class="bi d-block mx-auto mb-1" width="32" height="32">
                            ...
                            <li>
                                <a href="../admin/admin-gestion-vendeurs.php" class="nav-link text-white">
                                    <svg class="bi d-block mx-auto mb-1" width="32" height="32">
                        ...
                        <?php }
                        if (isset($_SESSION['connect']) && $_SESSION['connect'] == 1 && ($_SESSION['role'] == 'Admin' || $_SESSION['role'] == 'Vendeur')) { ?>
                            <!-- gestion des produits -->
                            <li>
                                <a href="../admin/admin-gestion-produits.php" class="nav-link text-white">
                                    <svg class="bi d-block mx-auto mb-1" width="32" height="32">
                                        <use xlink:href="#grid" />
                                    </svg>
                                    Produits
                        ...
                        <li>
                            <div class="dropdown text-end">
                                ...
                                <a href="#" class="nav-link  text-white" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="/img/profils/profil.png" alt="mdo" width="32" height="32" class="rounded-circle bi d-block mx-auto mb-1 bg-light">
                                    <?php if (isset($_SESSION['connect']) && $_SESSION['connect'] == 1 && $_SESSION['role'] == 'Admin') { ?> Administrateur <?php } else
                                    if (isset($_SESSION['connect']) && $_SESSION['connect'] == 1 && $_SESSION['role'] == 'Vendeur') { ?> Vendeur <?php } else { ?>Profil<?php } ?>
                                </a>
                                <ul class="dropdown-menu text-small">
                                    <li><a class="dropdown-item" href="/src/admin/admin-login.php">Log in</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="/src/admin/admin-logout.php">Log out</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
